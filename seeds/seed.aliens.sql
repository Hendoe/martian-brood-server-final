INSERT INTO aliens (alien_name, hp, atk, biomass_cost, synapse_required, description, special_features)
VALUES
  ...
  ('Worker Drone', 1, 1, 5, 1, 'Simple alien. Gathers Biomass for the growth of the Brood.', 'Able to do many tasks.')
