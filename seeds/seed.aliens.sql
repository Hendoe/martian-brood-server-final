...
VALUES
  (false, false, false, 'Brood Master', 10, 5, 0, 0, 'Lord of the Brood. Powerful, resourceful, and necessary to survival.', 'Game over if dies'),
  (true, true, false, 'Worker Drone', 1, 1, 5, 1, 'Simple alien. Gathers Biomass for the growth of the Brood.', 'Able to do many tasks.')
